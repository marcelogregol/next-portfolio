        ...
        <section className="section-shell section-divider section-surface-hero relative overflow-hidden pt-8 md:pt-12">
            ...
            <div className="container-base relative z-10 flex flex-col-reverse items-center gap-10 md:flex-row md:gap-8">
                <div className="w-full text-center md:w-1/2 md:text-left">
                    ...
                    <h1 className="mt-4 text-balance text-4xl font-extrabold tracking-tight sm:text-5xl md:max-w-xl md:text-6xl">
                        {hero.title}
                    </h1>
                    <p className="text-sub mt-4 max-w-2xl text-base leading-7 sm:text-lg md:max-w-xl md:leading-8">
                        {hero.subtitle}
                    </p>

                    <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap md:mt-7">
